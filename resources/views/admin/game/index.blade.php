                ...
                @if (session('success'))
                    ...
                    @csrf
                        ...
                        <div class="flex flex-row mt-10">
                            <x-jet-label for="game-date" value="{{ __('Datum wedstrijd') }}" class="text-lg text-left inline-block w-64"/>
                            <x-jet-input id="game-date" class="block mt-1 w-full" type="datetime-local" name="game-date"/>
                        </div>
