<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Indien nodig kunt u zich afmelden bij al uw andere browsersessies op al uw apparaten. Enkele van uw recente sessies worden hieronder vermeld; deze lijst is echter mogelijk niet volledig. Als u denkt dat uw account is gecompromitteerd, moet u ook uw wachtwoord bijwerken.') }}
        </div>
